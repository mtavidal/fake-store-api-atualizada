...
Esse repositório é uma atualização da FakeStoreAPI, para testes do front do desafio final da Gama Academy XP49 - grupo 01
...
Sugestao pra Retorno do post de Pedido e get de Pedidos:
{
"idpedido":
"idpessoa":
"valor":
